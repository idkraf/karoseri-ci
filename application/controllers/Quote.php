...
class Quote extends CI_Controller {
    ...
    public function action() {
        ...
        if ($this->db->insert('smartpos_quotes', $data)) {
            ...
            if ($prodindex > 0) {
                $this->db->insert_batch('smartpos_quotes_items', $productlist);
    ...
    public function ajax_list() {
        ...
        foreach ($list as $invoices) {
            ...
            $row[] = '<a href="' . base_url("quote/view?id=$invoices->id") . '" class="btn btn-success btn-sm"><span class="fa fa-eye"></span></a> &nbsp; <a href="' . base_url("quote/printquote?id=$invoices->id") . '&d=1" class="btn btn-info btn-sm"  title="Download"><span class="fa fa-download"></span></a>&nbsp;<a href="#" data-object-id="' . $invoices->id . '" class="btn btn-danger btn-sm delete-object"><span class="fa fa-trash"></span></a>';
            $data[] = $row;
        }
    ...
    public function editaction() {
        ...
        $this->db->delete('smartpos_quotes_items', array('tid' => $invocieno));
        $product_id = $this->input->post('pid');
        $product_name1 = $this->input->post('product_name', true);
        $product_qty = $this->input->post('product_qty');
        $product_price = $this->input->post('product_price');
        ...
        if ($flag) {
            ...
            if ($this->db->update('smartpos_quotes', $data)) {
                $this->db->insert_batch('smartpos_quotes_items', $productlist);
                echo json_encode(array('status' => 'Success', 'message' =>
