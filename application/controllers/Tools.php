...
class Tools extends CI_Controller {
    ...
    public function todo_load_list() {
        ...
        foreach ($list as $task) {
            $no++;
            $name = '<a class="check text-default btn btn-success btn-sm text-white" data-id="' . $task->id . '" data-stat="Due"> <i class="fa fa-check"></i> </a><a class="btn btn-sm btn-danger" href="#" data-id="' . $task->id . '" class="view_task">' . $task->name . '</a>';
            if ($task->status == 'Done') {
                $name = '<a class="check text-success btn btn-success btn-sm text-white" data-id="' . $task->id . '" data-stat="Done"> <i class="fa fa-check"></i> </a><a class="btn btn-sm btn-danger" href="#" data-id="' . $task->id . '" class="view_task">' . $task->name . '</a>';
            }
            $row = array();
            $row[] = $no;
            $row[] = '<a href="#" class="btn btn-primary btn-sm rounded set-task mr-2" data-id="' . $task->id . '" data-stat="0"> SET </a>' . $name;
    ...
    public function notes_load_list() {
        ...
        foreach ($list as $note) {
            ...
            $row[] = '<a href="editnote?id=' . $note->id . '" class="btn btn-primary btn-sm"><span class="fa fa-eye"></span> ' . '</a> <a class="btn btn-danger btn-sm delete-object" href="#" data-object-id="' . $note->id . '"> <i class="fa fa-trash"></i> </a>';
            $data[] = $row;
        }
    ...
    public function document_load_list() {
        ...
        foreach ($list as $document) {
            ...
            $row[] = '<a href="' . base_url('userfiles/documents/' . $document->filename) . '" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> ' . '</a> <a class="btn btn-danger btn-sm delete-object" href="#" data-object-id="' . $document->id . '"> <i class="fa fa-trash"></i> </a>';
