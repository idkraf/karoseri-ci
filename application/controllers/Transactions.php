...
class Transactions extends CI_Controller {
    ...
    public function payinvoice() {
        ...
        if ($totalrm > $amount) {
            ...
            if ($totalrm < $amount) {
                ...
                $this->db->update('smartpos_transactions');
            }
            $this->db->set('pmethod', $pmethod);
    ...
    public function cancelinvoice() {
        ...
        $this->db->delete('smartpos_transactions', array('tid' => $tid));
    ...
    public function cancelpurchase() {
        ...
        $this->db->delete('smartpos_transactions', array('tid' => $tid, 'ext' => 1));
        echo json_encode(array('status' => 'Success', 'message' =>
    ...
    public function delete_cat() {
        ...
        if ($id) {
            $this->db->delete('smartpos_trans_cat', array('id' => $id));
