...
class Subscriptions_model extends CI_Model {
    ...
    var $column_order = array(null, 'smartpos_invoices.tid', 'smartpos_customers.name', 'smartpos_invoices.invoicedate', 'smartpos_invoices.total', 'smartpos_invoices.status', null, null);
    ...
    private function _get_datatables_query($opt = '') {
        $this->db->select('smartpos_invoices.id,smartpos_invoices.tid,smartpos_invoices.invoicedate,smartpos_invoices.invoiceduedate,smartpos_invoices.total,smartpos_invoices.status,smartpos_invoices.i_class,smartpos_customers.name');
        $this->db->from($this->table);
