...
class Tools_model extends CI_Model {
    ...
    public function setgoals($income, $expense, $sales, $netincome) {
        ...
        $this->db->set($data);
        $this->db->where('id', 1);
        return $this->db->update('smartpos_goals');
    }
    ...
    function deletenote($id) {
        return $this->db->delete('smartpos_notes', array('id' => $id));
    }
    ...
    function deletedocument($id) {
        ...
        if ($this->db->delete('smartpos_documents', array('id' => $id))) {
