<div class="card border border-1 shadow bg-light">
    <div class="card-body">
        <div class="card-header">
            <a href='#' class="btn btn-primary btn-sm float-end rounded" data-toggle="modal" data-target="#addCustomer"><?php echo $this->lang->line('Add Client') ?></a>
        </div>
        <div class="card-body">
                        ...
                        <div id="customerpanel" class="card border  border-1 shadow">
                            <div class="card-body">
                                ...
                                <div id="customer">
                                    ...
                                    <select  id="s_warehouses" class="form-select rounded-0">
                                        <?php
                    ...
                    <div class="col-sm-6">
                        <div class="card border border-1 shadow">
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <h3 class="title"><?php echo $this->lang->line('Invoice Properties') ?></h3>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="invocieno"><?php echo $this->lang->line('Reference') ?></label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control rounded-0 required" name="invocieduedate"  placeholder="Due Date" autocomplete="false"    data-toggle="datepicker">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6">
        ...
        <div id="saman-row">
            <table class="table-responsive tfr my_stripe table-bordered table-striped table-sm">
                <thead>
                    <tr class="bg-warning">
                ...
                <tbody>
                    <tr>
                        <td>
                            <input type="text" class="form-control rounded-0" name="product_name[]"
                                   placeholder="<?php echo $this->lang->line('Enter Product name') ?>"
                                   id='productname-0'>
                        </td>
                        <td>
                            <input type="text" class="form-control rounded-0 req amnt" name="product_qty[]" id="amount-0"
                                   onkeypress="return isNumber(event)" onkeyup="rowTotal('0'), billUpyog()"
                                   autocomplete="off" value="1"><input type="hidden" id="alert-0" value=""
                                   name="alert[]"></td>
                        <td>
                            <input type="text" class="form-control rounded-0 req prc" name="product_price[]" id="price-0"
                                   onkeypress="return isNumber(event)" onkeyup="rowTotal('0'), billUpyog()"
                                   autocomplete="off"></td>
                        <td>
                            <input type="text" class="form-control rounded-0 vat " name="product_tax[]" id="vat-0"
                                   onkeypress="return isNumber(event)" onkeyup="rowTotal('0'), billUpyog()"
                                   autocomplete="off"></td>
                        <td class="text-center" id="texttaxa-0">0</td>
                        <td>
                            <input type="text" class="form-control rounded-0 discount" name="product_discount[]"
                ...
                <tr>
                    <td colspan="8">
                        <textarea id="dpid-0" class="form-control rounded-0" name="product_description[]"
                ...
                <tr class="sub_c" style="display: table-row;">
                    ...
                    <td align="left" colspan="2" class="bg-warning text-white">
                        <input type="text" class="form-control rounded-0 border border-1 border-primary shipVal" onkeypress="return isNumber(event)"
                               placeholder="Value"
                ...
                <tr class="sub_c" style="display: table-row;">
                    ...
                    <td align="left" class="bg-success text-white" colspan="2">
                        <input type="text" class="form-control rounded-0 border border-1 border-primary discVal"
                ...
                <tr class="sub_c" style="display: table-row;">
                    <td colspan="2"><?php
                        ...
                        if ($exchange['active'] == 1) {
                            ...
                            ?></small>
                            <select name="mcurrency" class="selectpicker form-select rounded-0">
                    ...
                    <td align="left" colspan="2" class="bg-danger text-white">
                        <input type="text" name="total" class="form-control rounded-0 border border-1 border-danger" id="invoiceyoghtml" readonly="">
                    </td>
                </tr>
                <tr class="sub_c" style="display: table-row;">
                    <td colspan="2">
                    ...
                    <td class="reverse_align" colspan="6">
                        <input type="submit" class="btn btn-success sub-btn btn-lg"  value="<?php echo $this->lang->line('Generate Invoice') ?> " id="submit-data" data-loading-text="Creating...">
                    </td>
                </tr>
                </tbody>
            </table>
