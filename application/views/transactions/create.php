...
<div class="card border border-1  bg-light">
    <div class="card-header">
        <button class="btn btn-outline-warning rounded-0">
            <h5 class="text-dark"><?php echo $this->lang->line('Add New Transaction') ?></h5>
        </button>
                ...
                <div class="card border border-1">
                    <div class="card-body">
                        <form method="post" id="data_form">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="text" class="form-control rounded-0 bg-primary text-white" name="cst" id="trans-box"
                            ...
                            <div id="customerpanel" class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <label for="toBizName" class="form-label"><?php echo $this->lang->line('C/o') ?>
                                        <span  style="color: red;">*</span></label>
                                            <input type="hidden" name="payer_id" id="customer_id" value="0">
                                    <input type="text" class="form-control rounded-0 required" name="payer_name" id="customer_name">
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <label class="form-label" for="amount"><?php echo $this->lang->line('Amount') ?></label>
                            ...
                            <div class="form-group row ">
                                <div class="col-sm-4">
                                    <label class="form-label" for="date"><?php echo $this->lang->line('Date') ?></label>
                                    <input type="text" class="form-control rounded-0 required" name="date" data-toggle="datepicker" autocomplete="false">
                                </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select name="pay_type" class="form-select rounded-0">
                                        <option value="Income"
                                ...
                                <div class="col-sm-4">
                                    <label class="form-label"  for="pay_cat"><?php echo $this->lang->line('Category') ?></label>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <label class="form-label"  for="product_price"><?php echo $this->lang->line('Method') ?> </label>
                                    <select name="paymethod" class="form-select rounded-0">
                            ...
                            <?php if ($dual['key1']) { ?>
                                ...
                                <div id="customerpanel" class="form-group row bg-purple bg-lighten-4 pb-1">
                                    <div class="col-sm-4">
                                        ...
                                        <select name="f_pay_acc" class="form-select rounded-0">
                                            <?php
                                            foreach ($accounts as $row) {
                                                $cid = $row['id'];
                                                $acn = $row['acn'];
                                    ...
                                    <div class="col-sm-4">
                                        <label class="form-label" for="f_pay_cat"><?php echo $this->lang->line('From') . ' ' . $this->lang->line('Category') ?></label>
                                        <select name="f_pay_cat" class="form-select rounded-0">
                                            <?php
                                            foreach ($cat as $row) {
                                                $cid = $row['id'];
                                                $title = $row['name'];
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <input type="submit" id="submit-data" class="btn btn-primary btn-lg"
