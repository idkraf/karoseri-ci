<div class="card-body">
                ...
                <div class="card-body">
                    <div class="media d-flex">
                        ...
                        <div class="align-self-center">
                            <i class="icon-rocket success font-large-2"></i>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card shadow rounded border border-1">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="float-end">
                        <a href="<?php echo base_url('products/add') ?>" class="btn btn-primary btn-sm rounded"><?php echo $this->lang->line('Add new') ?></a>  
                        <a href="<?php echo base_url('products') ?>?group=yes" class="btn btn-danger btn-sm rounded"><i class="ft-grid"></i></a> 
                        <a href="<?php echo base_url('products') ?>" class="btn btn-success btn-sm rounded"><i class="ft-list"></i></a>
        ...
        <div class="card-body">
            ...
            <div class="card-body">
                <table id="productstable" class="table table-striped table-bordered border-primary table-sm table-hover" cellspacing="0"
                       width="100%">
                    <thead>
                        <tr class="bg-light">
                            <th>#</th>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" data-dismiss="modal" class="btn btn-danger"><?php echo $this->lang->line('Close');?></button>
                    </div>
                </div>
            </div>
        </div>
