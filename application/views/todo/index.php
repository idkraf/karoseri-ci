    ...
    <div class="card border border-1 shadow bg-light">
        <div class="card-header">
            <div class="row">
                <div class="col-md-6">
                    <button class="btn btn-outline-warning rounded-0 text-dark">&nbsp;&nbsp;<strong><?php echo $this->lang->line('Task') ?></strong>&nbsp;&nbsp;</button>
                </div>
                <div class="col-md-6">
                    <a href="<?= base_url() ?>tools/addtask" class="btn btn-primary float-end rounded-0">Add New </a>
                </div>
            </div>
        ...
        <div class="card-body border border-2">
            ...
            <table id="todotable" class="table table-striped table-bordered zero-configuration table-hover table-sm">
                <thead>
                <tr>
                    <th>#</th>
