                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="0"
                                       class="form-control rounded-0 price_input" name="pice">
                            </div>

                            <div class="form-group">
                                <label class="form-label" for="bbn">BBN</label>
                                <input type="text" placeholder="0.000"
                                       class="form-control rounded-0  required bbn_input" name="bbn">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="disc">Disc</label>
                                <input type="text" placeholder="0"
                                       class="form-control rounded-0 required disc_input" name="disc">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="tax">Tax</label>
                                <input type="text" placeholder="0"
                                       class="form-control rounded-0 required tax_input" name="tax">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="taxppn">Tax</label>
                                <input type="text" placeholder="0"
                                       class="form-control rounded-0 required ppn_input" name="taxppn">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="taxppn">Cogs R</label>
                                <input type="text" placeholder="0"
                                       class="form-control rounded-0 required total_input" name="total">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="taxppn">Cogs E</label>
                                <input type="text" placeholder="0"
                                       class="form-control rounded-0 required totale_input" name="totale">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                           ...
                           <br>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rounded-0 txt_customer_name" name="customer_name" readonly>
                                <input type="text" class="form-control rounded-0 txt_customer_code" name="customer_code" readonly>
                           </div>
                           <br>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control rounded-0 txt_vehicle_code" name="vehicle_code" readonly>
                                <input type="text" class="form-control rounded-0 txt_vehicle_name" name="vehicle_name" readonly>
                           </div>
                           <br>
                            <div class="form-group">
                                <label class="form-label" for="customer">Template </label>     
                                <button type="button" class="btn btn-info float-end" data-toggle="modal" data-target="#dataTemplate"><b>Pilih Template</b></button>
                            
                                <input type="hidden" class="form-control rounded-0 txt_template_id" name="template_id" value="0" readonly>
                                <input type="text" class="form-control rounded-0 txt_template_name" name="template_name" readonly>
                           </div>

                            <div class="form-group">
                                <input type="submit" id="submit-data" class="btn btn-success float-end"
                                       value="&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->lang->line('Add') ?>&nbsp;&nbsp;&nbsp;&nbsp;" data-loading-text="Adding...">
                                <input type="hidden" value="produksi/add" id="action-url">
                            </div>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">	
	...
	$("#submit-data").on("click", function () {
        ...
        var tid = 'template_id=' + $('.txt_template_id').val();
