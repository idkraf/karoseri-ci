<div class="card border border-1 shadow bg-light">
    <div class="card-header">
        <a href='#' class="btn btn-primary float-end btn-sm rounded"  data-toggle="modal" data-target="#addCustomer">
    ...
    <div class="card-body">
        ...
        <div class="card-body">
            ...
            <form method="post" id="data_form">
                <div class="row">
                    <div class="col-sm-6 cmp-pnl">
                        <div class="card border border-1 shadow">
                            <div class="card-header"><h3 class="title"><?php echo $this->lang->line('Bill To') ?></h3></div>
                            <div class="card-body">
                                <div id="customerpanel" class="inner-cmp-pnl">
                                    ...
                                    <div class="form-group row">
                                        <div class="frmSearch col-sm-12"><label for="cst" class="caption"><strong><?php echo $this->lang->line('Search Client') ?></strong></label>
                                            <input type="text" class="form-control rounded-0" name="cst" id="customer-box" placeholder="Enter Customer Name or Mobile Number to search"  autocomplete="off"/>
                                            <div id="customer-box-result"></div>
                                        </div>

                                    </div>
                                    <div id="customer" class="mb-2">
                                        <div class="clientinfo">
                                            <strong><?php echo $this->lang->line('Client Details') ?></strong>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <label for="toAddInfo" class="caption"><strong><?php echo $this->lang->line('Proposal Message') ?></strong></label>
                                            <textarea class="summernote" name="propos" id="contents" rows="2"></textarea>
                                        </div>
                                    </div>
                    ...
                    <div class="col-sm-6 cmp-pnl">
                        <div class="card border border-1 shadow">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <label for="invocieno" class="caption"><?php echo $this->lang->line('Quote Number') ?></label>
                                        <input type="text" class="form-control rounded-0" placeholder="Quote #"
                                               name="invocieno"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control rounded-0" placeholder="Reference #"
                                               name="refer">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="invociedate"  class="caption"> <?php echo $this->lang->line('Quote Date') ?></label>
                                        <input type="text" class="form-control required rounded-0"  placeholder="Billing Date" name="invoicedate"  data-toggle="datepicker" autocomplete="false">
                                    </div>

                                    <div class="col-sm-6">
                                        <label for="invocieduedate"  class="caption"><?php echo $this->lang->line('Quote Validity') ?></label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select rounded-0" onchange="changeDiscountFormat(this.value)"
                                                    id="discountFormat">
                ...
                <div id="saman-row">
                    <table class="table-responsive tfr my_stripe table-striped table-bordered table-sm">
                        <thead>
                        ...
                        <tr class="sub_c" style="display: table-row;">
                            ...
                            <td align="left" class="bg-primary text-white" colspan="2"><span
                        ...
                        <tr class="sub_c" style="display: table-row;">
                            ...
                            <td align="left" class="bg-info text-white" colspan="2"><span
                                    class="currenty lightMode"><?php echo $this->config->item('currency'); ?></span>
                        ...
                        <tr class="sub_c" style="display: table-row;">
                            ...
                            <td align="left" class="bg-warning text-white" colspan="2">
                        ...
                        <tr class="sub_c" style="display: table-row;">
                            <td colspan="2"><?php
                                if (isset($employee)) {
                                    ...
                                    ?><br>
                                    <select name="employee"  class=" mt-1 col form-select rounded-0">
                                        <?php
                            ...
                            <td colspan="4" align="right">
                                <strong><?php echo $this->lang->line('Grand Total') ?>(<span class="currenty lightMode"><?php echo $this->config->item('currency'); ?></span>)</strong>
                            </td>
                            <td align="left" colspan="2" class="bg-danger text-white">
                                <input type="text" name="total" class="form-control rounded-0 border border-1 border-warning" id="invoiceyoghtml" readonly="">
                            </td>
                        </tr>
                        <tr class="sub_c" style="display: table-row;">
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <label class="form-label" for="name"><?php echo $this->lang->line('Name') ?></label>
                                            ...
                                            <input type="text" placeholder="Name"
                                                   class="form-control margin-bottom rounded-0" id="mcustomer_name" name="name" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="form-label"
                                            ...
                                            <input type="text" placeholder="Phone" class="form-control margin-bottom rounded-0" name="phone" id="mcustomer_phone">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="City"
                                                   class="form-control margin-bottom rounded-0" name="city" id="mcustomer_city">
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="Region" id="region"
                                                   class="form-control margin-bottom rounded-0" name="region">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" placeholder="TAX ID"
                                                   class="form-control margin-bottom rounded-0" name="taxid" id="mcustomer_city">
                                        </div>
                                    </div>
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <label class="form-label"  for="name_s"><?php echo $this->lang->line('Name') ?></label>

                                
                                    <input type="text" placeholder="Name"
                                           class="form-control margin-bottom rounded-0" id="mcustomer_name_s" name="name_s"
                                           required>
                            ...
                            <div class="form-group">
                                ...
                                <label class="form-label"
                                    ...
                                    <input type="text" placeholder="Phone"
                                           class="form-control margin-bottom rounded-0" name="phone_s" id="mcustomer_phone_s">
                            ...
                            <div class="form-group">
                                ...
                                <label class="form-label"
                                    ...
                                    <input type="email" placeholder="Email"
                                           class="form-control margin-bottom rounded-0" name="email_s"
                            ...
                            <div class="form-group">
                                ...
                                <label class="form-label"
                                    ...
                                    <input type="text" placeholder="Address"
                                           class="form-control margin-bottom rounded-0" name="address_s"
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <input type="text" placeholder="City"
                                           class="form-control margin-bottom rounded-0" name="city_s" id="mcustomer_city_s">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" placeholder="Region" id="region_s"
                                           class="form-control margin-bottom rounded-0" name="region_s">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" placeholder="Country"
                                           class="form-control margin-bottom rounded-0" name="country_s" id="mcustomer_country_s">
                                </div>
                                <div class="col-sm-6">
                                    <input type="text" placeholder="PostBox" id="postbox_s"
                                           class="form-control margin-bottom rounded-0" name="postbox_s">
                                </div>
                            </div>
                                </div>
                            </div>
