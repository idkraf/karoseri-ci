<div class="card border border-1 shadow bg-light p-5">
    <div class="card-header">
        <div class="row">
            <div class="col-md-6">
                <h4 class="card-title"><?php echo $this->lang->line('Quotes') ?></h4>
            </div>
            <div class="col-md-6">
                <a
                    href="<?php echo base_url('quote/create') ?>"
                    class="btn btn-primary btn-sm float-end rounded">
    ...
    <div class="card-body border border-2">
        ...
        <div class="card-body">
            ...
            <div class="card border border-1">
                ...
                <div class="col-md-2">
                    <label><?php echo $this->lang->line('Quote Date') ?></label>
                ...
                <div class="col-md-2">
                    <input type="button" name="search" id="search" value="Search" class="btn btn-warning mt-4 btn-sm"/>
                </div>
            </div>
                </div>
            </div>
            ...
            <div class="card border border-1">
                <div class="card-body">
                    <table id="quotes" class="table table-striped table-bordered table-hover table-sm zero-configuration">
                <thead>
                    <tr>
