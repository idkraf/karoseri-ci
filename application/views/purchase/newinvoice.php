<div class="card shadow border border-1 rounded-0">
    <div class="card-header">
        <div class="row">
            <div class="col-md-12">
                <a href='#' class="btn btn-primary btn-sm rounded float-end" data-toggle="modal" data-target="#addCustomer"><?php echo $this->lang->line('Add Supplier') ?></a>
            </div>
        </div>
    </div>
    <div class="card-body bg-light">
        ...
        <div class="card-body">
            <form method="post" id="data_form">
                                ...
                                <div id="customerpanel" class="inner-cmp-pnl">
                                    <div class="form-group row">
                                        <div class="fcol-sm-12">
                                            <h3 class="title"><?php echo $this->lang->line('Bill From') ?></h3>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <div class="frmSearch">
                                            <label for="cst" class="form-label"><?php echo $this->lang->line('Search Supplier') ?> </label>
                                            <input type="text" class="form-control rounded-0" name="cst" id="supplier-box"
                    ...
                    <div class="col-sm-6">
                        <div class="card shadow border border-2">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <label for="invocieno" class="form-label"><?php echo $this->lang->line('Order Number') ?> </label>

                                        <input type="text" class="form-control rounded-0" placeholder="Invoice #" name="invocieno" value="<?php echo $lastinvoice + 1 ?>">

                                    </div>
                                    <div class="col-sm-6">
                                        <label for="invocieno" class="form-label"><?php echo $this->lang->line('Reference') ?> </label>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6"><label for="invociedate"
                                                                 class="form-label"><?php echo $this->lang->line('Order Date') ?> </label>
                                    ...
                                    <div class="col-sm-6">
                                        <label for="invocieduedate"
                                               class="form-label"><?php echo $this->lang->line('Order Due Date') ?> </label>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <label for="taxformat"
                                               class="form-label"><?php echo $this->lang->line('Tax') ?> </label>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="discountFormat"
                                                   class="form-label"><?php echo $this->lang->line('Discount') ?></label>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <label for="toAddInfo"
                                               class="form-label"><?php echo $this->lang->line('Order Note') ?> </label>
                                        <textarea class="form-control rounded-0" placeholder="Order Note" name="notes" rows="2"></textarea></div>
                                </div>
                            </div>
                        </div>
                    </div>    
                ...
                <div id="saman-row">
                    <table class="table-responsive table-bordered table-striped table-sm tfr my_stripe">
                        <thead>
                        ...
                        <tbody>
                            <tr>
                                <td><input type="text" class="form-control rounded-0 text-center" name="product_name[]"
                                           placeholder="<?php echo $this->lang->line('Enter Product name') ?>"
                                           id='productname-0'>
                                </td>
                                <td><input type="text" class="form-control rounded-0 req amnt" name="product_qty[]" id="amount-0"
                                           onkeypress="return isNumber(event)" onkeyup="rowTotal('0'), billUpyog()"
                                           autocomplete="off" value="1"></td>
                                <td><input type="text" class="form-control rounded-0 req prc" name="product_price[]" id="price-0"
                                           onkeypress="return isNumber(event)" onkeyup="rowTotal('0'), billUpyog()"
                                           autocomplete="off"></td>
                                <td><input type="text" class="form-control rounded-0 vat " name="product_tax[]" id="vat-0"
                                           onkeypress="return isNumber(event)" onkeyup="rowTotal('0'), billUpyog()"
                                           autocomplete="off"></td>
                                <td class="text-center" id="texttaxa-0">0</td>
                                <td><input type="text" class="form-control rounded-0 discount" name="product_discount[]"
                        ...
                        <tr hidden>
                            <td colspan="8"><textarea id="dpid-0" class="form-control rounded-0" name="product_description[]"
                        ...
                        <tr class="sub_c" style="display: table-row;">
                            <td colspan="6" align="right" class="bg-light">
                        ...
                        <tr class="sub_c" style="display: table-row;">
                            ...
                            <td align="left" colspan="2"><input type="text" class="form-control rounded-0 shipVal"
                        ...
                        <tr class="sub_c" style="display: table-row;">
                            ...
                            <td align="left" colspan="2"><input type="text" name="total" class="form-control bg-primary text-white rounded-0"
                ...
                <div class="modal-body p-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Name"
                               class="form-control rounded-0" id="mcustomer_name" name="name" required>
                    ...
                    <div class="form-group">
                        ...
                        <label class="form-label" for="email">Email</label>
                            ...
                            <input type="email" placeholder="Email"
                                   class="form-control margin-bottom rounded-0 crequired" name="email" id="mcustomer_email">
                    ...
                    <div class="form-group">
                        <label class="form-label"
                            ...
                            <input type="text" placeholder="Address"
                                   class="form-control margin-bottom rounded-0" name="address" id="mcustomer_address1">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" placeholder="Region"
                                   class="form-control rounded-0 margin-bottom" name="region">
                        </div>
                        <div class="col-sm-4">
                            <input type="text" placeholder="Country"
                                   class="form-control rounded-0 margin-bottom" name="country" id="mcustomer_country">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            <input type="text" placeholder="PostBox"
                                   class="form-control rounded-0 margin-bottom" name="postbox">
                        </div>
                        <div class="col-sm-6">
                            <input type="text" placeholder="TAX ID"
                                   class="form-control rounded-0 margin-bottom" name="taxid" id="tax_id">
                        </div>
                    </div>
                </div>
