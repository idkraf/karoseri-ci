<div class="card border border-1 bg-light">
    <div class="card-header">
        <h5 class="title"> <?php echo $this->lang->line('Business Registers') ?></h5>
    ...
    <div class="card-body">
        ...
        <div class="card-body border border-2">
            ...
            <table id="regi_table" class="table table-striped table-bordered table-hover table-sm">
                <thead>
                    <tr>
                        <th>#</th>
...
<div class="modal fade" id="view_register" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content ">
            <!-- Modal Header -->
            <div class="modal-header">
                <div class="modal-title"><button class="btn btn-outline-warning rounded-0 text-dark"><strong><?php echo $this->lang->line('Register') ?></strong></button></div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-6">
                        <div class="form-group green">
                            <label class="form-label" for="amount"><?php echo $this->lang->line('Cash') ?></label>
                            <input type="number" class="form-control rounded-0 green" id="r_cash" value="0.00" readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group  blue">
                            <label class="form-label" for="b_change blue"><?php echo $this->lang->line('Card') ?></label>
                            <input type="number" class="form-control rounded-0 blue" id="r_card" value="0" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group  indigo">
                            <label class="form-label" for="amount"><?php echo $this->lang->line('Bank') ?>
                            </label>
                            <input type="number" class="form-control rounded-0 indigo" id="r_bank"
                                   value="0.00"
                                   readonly>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group red">
                            ...
                            <input
                                type="number"
                                class="form-control rounded-0 red"
