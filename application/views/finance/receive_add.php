            ...
            <div class="row mt-2">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover text-nowrap">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" id="txt_debit" name="data[debit]" value="0">
                                    <script>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" id="txt_credit" name="data[credit]" value="0">
                                    <script>
                        ...
                        <tbody id="temp_list"><tr><td></td><td class="text-bold text-right">0.0000</td><td class="text-bold text-right">0.0000</td><td></td></tr></tbody>
                    </table>
                </div>
            </form>
            </div>
...
<script>
    ...
    $('#frm').submit(function () {
        ...
        if (_msg) {
            ...
            $.ajax({
                url: '/finance/api_receive_save', type: 'post', dataType: 'json', data: $(this).serialize(),
                success: function (_json) {
                    if (_json.status == 1) { 
