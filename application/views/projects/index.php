    ...
    <div class="card border border-1 bg-light">
        <div class="card-header">
            <div class="row">
                <div class="col-md-6">
                    <button class="btn btn-outline-warning text-dark rounded-0"><strong><?php echo $this->lang->line('Projects') ?> </strong></button>
                </div>
                <div class="col-md-6">
                   <a href="<?php echo base_url('projects/addproject') ?>"  class="btn btn-primary float-end rounded-0">
        ...
        <div class="card-body">
            ...
            <div class="card-body border border-2">
                ...
                <table id="ptable" class="table table-striped table-bordered zero-configuration table-hover table-sm" cellspacing="0"
                       width="100%">
                    <thead>
                    <tr>
                        <th>#</th>
