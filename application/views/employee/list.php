<div class="card border border-1 bg-light">
    <div class="card-header">
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="<?php echo base_url('employee/add') ?>"  class="btn btn-primary rounded-0 float-end">
            ...
            <table id="emptable" class="table table-striped table-bordered table-hover table-sm">
                ...
                <tbody>
                    ...
                    foreach ($employee as $row) {
                        ...
                        if ($status == 1) {
                            $status = 'Deactive';
                            $btn = "<a href='#' data-object-id='" . $aid . "'  data-object1-id='" . $aid . "'  class='btn btn-warning btn-sm delete-object' title='Enable'><i class='icon-eye-slash'></i></a>";
                        } else {
                            $status = 'Active';
                            $btn = "<a href='#' data-object-id='" . $aid . "' class='btn btn-warning btn-sm delete-object' title='Disable'><i class='fa fa-chain-broken'></i> " . "</a>";
                        }
                    ...
                    <td>$role</td>                 
                    <td>$status</td>
                    <td><a href='" . base_url("employee/view?id=$aid") . "' class='btn btn-success btn-sm'><i class='fa fa-eye'></i> "  . "</a>&nbsp;&nbsp;$btn&nbsp;&nbsp;<a href='#pop_model' data-toggle='modal' data-remote='false' data-object-id='" . $aid . "' class='btn btn-danger btn-sm delemp' title='Delete'><i class='fa fa-trash'></i></a></td></tr>";
                        $i++;
                    }
                    ?>
                </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" data-dismiss="modal" class="btn btn-danger" id="delete-confirm">Deativate
                    </button>
