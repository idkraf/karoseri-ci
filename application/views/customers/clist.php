...
?>
    <div class="card border border-1 bg-light shadow">
        <div class="card-header">
            <div class="row">
                <div class="col-md-6">
                    <a href="<?php echo base_url('customers') ?>" class="mr-5 btn btn-warning rounded-0">
                    <?php echo $this->lang->line('Clients') ?></a> 
                <a href="<?php echo base_url('customers/create') ?>" class="btn btn-primary rounded-0"><?php echo $this->lang->line('Add new') ?></a> 
                <a href="<?php echo base_url('customers?due=true') ?>"  class="btn btn-danger  rounded-0">
        ...
        <div class="card-body">
            ...
            <div class="card-body border border-2 bg-light">
                ...
                <table id="clientstable" class="table table-striped table-bordered zero-configuration table-sm" cellspacing="0">
                    <thead>
                        <tr>
                            <th>#</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal" aria-hidden="true">X</button>
            </div>
            ...
            <div class="modal-body">
                <form id="sendmail_form">
                    ...
                    <div class="row">
                        <div class="col mb-1">
                            <label for="shortnote"><?php echo $this->lang->line('Message') ?></label>
                            <textarea name="text" class="summernote rounded-0" id="contents" title="Contents"></textarea></div>
                    </div>
