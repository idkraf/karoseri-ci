<div class="card border border-1 bg-light shadow p-2 mt-4">
    <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="card border border-1">
                        <div class="card-body">
                            ...
                            <table class="table table-striped table-bordered table-sm  border border-success">
                                ...
                                <tbody id="pos_items" class="saman-pos2">
                                </tbody>
                            </table>
                            ...
                            <table class="mt-3 table table-striped table-bordered table-sm">
                                <tr>
                                    <td><strong> <?php echo $this->lang->line('Shipping') ?></strong></td>
                                    <td>
                                        <input type="text" class="form-control rounded-0 shipVal"
                                    ...
                                    <td>
                                        <strong>( <?php echo $this->lang->line('Tax') ?> <?= $this->config->item('currency'); ?>
                                            <span id="ship_final">0</span> )</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td><strong> <?php echo $this->lang->line('Total Tax') ?></strong></td>
                                    <td>
                                        <?php echo currency($this->aauth->get_user()->loc); ?><span id="taxr" class="mr-1">0</span>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td><strong> <?php echo $this->lang->line('Total Discount') ?></strong></td>
                                    <td>
                                        <?php echo currency($this->aauth->get_user()->loc); ?><span id="discs" class="lightMode mr-1">0</span>
                                        <small>(<?php echo $this->lang->line('Products') ?>)</small></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td><strong> <?php echo $this->lang->line('Grand Total') ?></strong></td>
                                    <td><?php echo currency($this->aauth->get_user()->loc);
                                        ?>
                                        <span class="font-medium-1 blue text-bold-600"
                                              id="bigtotal">0.00</span></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td><strong> <?php echo $this->lang->line('Extra') . ' ' . $this->lang->line('Discount') ?></strong></td>
                                    <td>
                                    ...
                                    <td>
                                        <strong>( <?= $this->config->item('currency'); ?>
                                            <span id="disc_final">0</span> )</strong>
                                    </td>
                                </tr>
                            </table>
                            <?php if ($emp['key1']) { ?>
                                <div class="form-group text-g">
                                    <label for="employee" class="form-label"><strong><?php echo $this->lang->line('Employee') ?></strong></label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="btn btn-primary rounded-0  mr-1 mb-1" id="base-tab1" data-toggle="tab"
                                               aria-controls="tab1" href="#tab1" role="tab" aria-selected="false"><i
                                                    class="fa fa-trophy"></i>
                                                <?php echo $this->lang->line('Coupon') ?></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="btn btn-danger rounded-0 mr-1 mb-1" id="base-tab2" data-toggle="tab"
                                        ...
                                        <li class="nav-item">
                                            <a class="btn btn-success rounded-0  mr-1 mb-1" id="base-tab3" data-toggle="tab"
                                               aria-controls="tab3" href="#tab3" role="tab" aria-selected="false"><i
                                                    class="fa fa-save"></i> <?php echo $this->lang->line('Draft') ?>(s)</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="btn btn-warning rounded-0 mb-1" id="base-tab4" data-toggle="tab"
                                    ...
                                    <div class="tab-content px-1 pt-1">
                                        <div class="tab-pane" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
                                            <div class="input-group">
                                                ...
                                                <button type="button" class="apply_couponc btn btn-small btn-primary"><?php echo $this->lang->line('Apply') ?></button>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="tab2" role="tabpanel" aria-labelledby="base-tab2">
                                            <div class="row">
                                                <div class="col-4">
                                                    ...
                                                    <select id="v2_warehouses" class="selectpicker form-select rounded-0  teal">
                                                        <?php
                                                ...
                                                <div class="col-4">
                                                    <strong><?php echo $this->lang->line('Tax') ?></strong>
                                                    <select class="form-select round rounded-0"
                                                            onchange="changeTaxFormat(this.value)"
                                                            id="taxformat">
                                                                <?php echo $taxlist; ?>
                                                    </select>
                                                </div>
                                                <div class="col-4">  <strong><?php echo $this->lang->line('Discount') ?></strong>
                                                    <select class="form-select rounded-0 round teal"
                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-9">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control text-center rounded-0 mousetrap" name="product_barcode" placeholder="Enter Product name, code or scan barcode" id="v2_search_bar" autocomplete="off" autofocus="autofocus">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <select id="v2_categories" class="selectpicker form-select rounded-0 teal">
                            ...
                            <section class="chat-app-form">
                                <div class="form-group text-center">
                                    ...
                                    <a href="<?= base_url('stockreturn/create_client') ?>" class="red float-right"><i class="fa fa-reply-all"></i></a>
                                </div>
                            </section>
                        </div>
                    </div>
        ...
        <div class="modal-content ">
            <form method="post" id="product_action" class="form-horizontal">
                ...
                <div class="modal-header bg-primary text-white">
                    <?php echo $this->lang->line('Add Customer') ?>
                    <button type="button" class="btn btn-danger btn-sm float-end" data-dismiss="modal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" placeholder="Phone"
                                           class="form-control rounded-0" name="phone" id="mcustomer_phone">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label"
            ...
            <form method="post" id="basicpay_data" class="form-horizontal">
                ...
                <div class="modal-body">
                        ...
                        <div class="col-6">
                            <div class="card-title">
                                ...
                                <div class="input-group">
                                    <input
                                        type="text"
                                        class="form-control rounded-0  text-bold-600 text-dark"
                                        name="p_amount"
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label class="form-label" for="amount"><?php echo $this->lang->line('Balance Due') ?>
                                </label>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label class="form-label" for="b_change"><?php echo $this->lang->line('Change') ?></label>
                                <input type="text" onkeypress="return isNumber(event)" class="form-control rounded-0 green" name="b_change" id="change_p" value="0">
                            </div>
                        </div>
                    </div>
                    <?php if (PAC) { ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <button class="btn btn-warning btn-lg"
                                    type="submit"
                                    id="pos_basic_print" data-type="4"></i> <?php echo $this->lang->line('Paynow') ?>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group  text-bold-600 green">
                            ...
                            <input type="number" class="form-control rounded-0" id="r_cash"
                                   value="0.00"
                                   readonly>
                        </div>
                    </div>
                    <div class="col-5 col-md-5 pull-right">
                        <div class="form-group text-bold-600 blue">
                            <label for="b_change "><?php echo $this->lang->line('Card') ?></label>
                            <input type="number" class="form-control rounded-0" id="r_card" value="0" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group  text-bold-600 indigo">
                            <label for="amount"><?php echo $this->lang->line('Bank') ?></label>
                            <input type="number" class="form-control rounded-0" id="r_bank" value="0.00" readonly>
                        </div>
                    </div>
                    <div class="col-5 col-md-5 pull-right">
                        <div class="form-group text-bold-600 red">
                            <label for="b_change"><?php echo $this->lang->line('Change') ?>(-)</label>
                            <input  type="number" class="form-control rounded-0" id="r_change" value="0" readonly>
                        </div>
                    </div>
                </div>
                <div class="row" style="display:none;">
    ...
    <div class="modal-dialog">
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                        <a href="<?= base_url() ?>/register/close" class="btn btn-primary  float-end" type="submit">
    ...
    <div class="modal-dialog ">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body border_no_print" id="print_section">
                <embed src="<?= base_url('assets/images/ssl-seal.png') ?>" type="application/pdf" height="600px" width="470" id="loader_pdf">
