<div class="card no-border bg-light">    
    <div class="card-body no-border">
        ...
        <table id="purchasepayment" class="table table-striped table-bordered zero-configuration table-sm ">
                <thead>
                    <tr>
                        <th class="no-sort">#</th>
                        <th>Date</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <input type="hidden" id="action-url" value="operation/posting_purchase_payment">
    ...
    $(document).ready(function () {
        ...
        function draw_data() {
            ...
            $('#purchasepayment').DataTable({
                ...
                'order': [],
                'ajax': {
                    'url': "<?php echo site_url('operation/ajax_purchase_payment_list') ?>",
                    'type': 'POST',
                    'data': {
                        'min':minData,
                        'max':maxData,
