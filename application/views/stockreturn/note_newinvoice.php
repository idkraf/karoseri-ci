<div class="card border border-1 bg-light">
    <div class="card-header">
        <div class="row">
            <div class="col-md-6">
                <button type="button" class="btn btn-warning rounded-0 text-dark">
                    <strong>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->lang->line('Bill To') ?>&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                </button>
            </div>
            <div class="col-md-6">
                <button type="button" class="btn btn-warning rounded-0 float-end text-dark">
                ...
                <form method="post" id="data_form">
                    ...
                    <div class="row">
                        <div class="col-sm-6 cmp-pnl">
                            <div id="customerpanel" class="card border border-1">
                                <div class="card-body">
                        ...
                        <div class="col-sm-6 cmp-pnl">
                            <div class="card border border-1">
                                <div class="card-header">
                                    ...
                                    <div class="col-sm-12">
                                        <h4  class="title"><?php echo $this->lang->line('Credit Note') ?> </h4>
                                    </div>
                    ...
                    <div class="card border border-2">
                        <div class="card-body">
                            <div id="saman-row">
                        <table class="table-responsive tfr my_stripe table-striped table-hover table-bordered table-sm">
                            <thead>
                            ...
                            <tr class="sub_c">
                                ...
                                <td align="left" colspan="2" class="bg-info text-white">
                                    <span  class="currenty lightMode"><?php echo $this->config->item('currency'); ?></span>
                            ...
                            <tr class="sub_c">
                                <td colspan="6" align="right">
                                    <strong><?php echo $this->lang->line('Shipping') ?>
                                    </strong>
                                </td>
                            ...
                            <tr class="sub_c">
                                ...
                                <td align="left" colspan="2" class="bg-danger text-white">
                                    <input type="text" name="total" class="form-control rounded-0 border border-0 border-warning" id="invoiceyoghtml" readonly="">
