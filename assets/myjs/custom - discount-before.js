...
var rowTotal = function (numb) {
    ...
    if (disFormat == 'flat') {
        ...
        totalPrice =  parseFloat(totalPrice) -  parseFloat(discountVal);
    }
    else if (disFormat == '%') {
		...
		totalPrice = deciFormat(totalPrice); }
